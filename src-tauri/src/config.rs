...
#[ts(export, export_to = "../../src/app/models/bindings/theme.ts")]
pub enum Theme {
    #[default]
    System,
    Light,
...
#[serde(default)]
#[ts(export, export_to = "../../src/app/models/bindings/app-config.ts")]
...
#[serde(default)]
#[ts(export, export_to = "../../src/app/models/bindings/obs-config.ts")]
...
#[derive(Default, Debug, Clone, serde::Serialize, serde::Deserialize, TS)]
#[serde(default)]
#[ts(export, export_to = "../../src/app/models/bindings/ffmpeg-config.ts")]
...
#[derive(Default, Debug, Clone, serde::Serialize, serde::Deserialize, TS)]
#[serde(default)]
#[ts(export, export_to = "../../src/app/models/bindings/process-paths.ts")]
...
#[derive(Default, Debug, Clone, serde::Serialize, serde::Deserialize, TS)]
#[serde(default)]
#[ts(export, export_to = "../../src/app/models/bindings/aimbeast-config.ts")]
    ...
    fn export_default_config() {
        ...
        let contents = format!(
            "// Generated from AppConfig::default(). Do not edit this file manually.\n\
             import type {{ AppConfig }} from './bindings/app-config';\n\
             \n\
